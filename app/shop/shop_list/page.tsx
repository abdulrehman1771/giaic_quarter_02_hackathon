      ...
      <div className="w-[90%] max-w-[1400px] mx-auto">
        ...
        <div className="flex w-full">
          <div className="grid gap-5 grid-cols-1 w-full">
            {data.map((tmp: IList, index: number) => {
              return (
                <div
                  key={index}
                  className="flex lg:flex-row flex-col gap-6 p-3 shadow-lg shadow-[#F6F6FD80] items-center"
                >
                  <div className="flex relative justify-center items-center w-full md:flex-col lg:flex-row lg:w-[350px] h-60 ">
                  ...
                  <div className="">
                    ...
                    <div className="flex my-3 gap-4 items-center font-semibold">
                      <h3 className="text-[#111C85]">
                        ${(tmp.discountPercentage / 100) * tmp.price}
                      </h3>
